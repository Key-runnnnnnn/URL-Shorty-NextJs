...
// all the database operations are done here in the repository layer
...
export default class UrlRepository {
  ...
  // async updateUrl(id: string, shortUrl: string): Promise<IUrl | null> {
  //   return await this.urlModel.findByIdAndUpdate(id, { shortUrl }, { new: true }).lean();
  // }
}
